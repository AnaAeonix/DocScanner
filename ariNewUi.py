...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.export_btn.setGeometry(QtCore.QRect(610, 20, 211, 31))
        ...
        self.export_btn.setIconSize(QtCore.QSize(20, 20))
        ...
        self.ocr_btn.setGeometry(QtCore.QRect(710, 60, 101, 31))
        self.ocr_btn.setStyleSheet("QPushButton {\n"
                                    "background-color: qlineargradient(x1:0, y1:0, x2:1, y2:1, stop:0 #8a2be2, stop:0.5 #0e86f6, stop:1 #a78bfa);\n"
                                    "        border-radius: 20px; \n"
                                    "    color: white; /* Text color */\n"
                                    "    font-weight: bold;\n"
        ...
        icon1.addPixmap(QtGui.QPixmap(":/newPrefix/pdf.svg"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.ocr_btn.setIcon(icon1)
        self.ocr_btn.setIconSize(QtCore.QSize(20, 20))
        self.ocr_btn.setObjectName("jpeg_btn")
        self.buttons_layout.addWidget(
            self.ocr_btn, alignment=QtCore.Qt.AlignTop)
        ...
        self.additional_label.setStyleSheet("#additional_label {"
                                            ...
                                            "border-radius: 10px;"   # Adjust the value for desired curve
                                            "}")
        self.additional_label.setFixedSize(210, 675)  # 680
        self.buttons_layout.addWidget(
        ...
        self.cam_drop_down.setGeometry(QtCore.QRect(840, 20, 200, 22))
        ...
        self.foc_label.setGeometry(QtCore.QRect(380, 20, 61, 21))
        self.foc_label.setObjectName("foc_label")
        self.trim_drop = QtWidgets.QComboBox(self.page)
        self.trim_drop.setGeometry(QtCore.QRect(620, 20, 101, 22))
        self.trim_drop.addItems(["Disable", "Enable"])
        self.trim_drop.setObjectName("trim_drop")
        self.trim_label = QtWidgets.QLabel(self.page)
        self.trim_label.setGeometry(QtCore.QRect(580, 20, 61, 21))
        ...
        self.crop_drop.setGeometry(QtCore.QRect(90, 20, 101, 22))
        self.crop_drop.addItems(["Manual Crop", "Auto Crop", "No Crop"])
        self.crop_drop.setObjectName("crop_drop")
        self.crop_label = QtWidgets.QLabel(self.page)
        self.crop_label.setGeometry(QtCore.QRect(50, 20, 61, 21))
        self.crop_label.setGeometry(QtCore.QRect(50, 20, 61, 21))
        self.crop_label.setObjectName("crop_label")
        self.dpi_drop = QtWidgets.QComboBox(self.page)
        self.dpi_drop.setGeometry(QtCore.QRect(280, 20, 81, 22))
        ...
        self.choosecam_label.setGeometry(QtCore.QRect(740, 20, 101, 21))
        ...
        self.settings_btn.setToolTip("Manual Crop")
